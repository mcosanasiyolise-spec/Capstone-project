...
class RpsGame():
    def __init__(self):
        ...
        self.r_btn = pygame.image.load("rock_button.jpg").convert_alpha()
        self.p_btn = pygame.image.load("paper_button.jpg").convert_alpha()
        self.s_btn = pygame.image.load("Scissors_button.png").convert_alpha()
        ...
        self.screen.blit(self.rock_button, (20, 500))
        self.screen.blit(self.paper_button, (330, 500))
        ...
        self.scissors_button = Button(640, 520, (640, 520), 300, 140)
    ...
    def player(self):
        if self.rock_button.clicked(30):
            ...
            self.scissors_button.clicked(640)
